...
namespace AnalysisToolkit {
    ...
    public:
        ...
        void flush();
        bool isConsoleEnabled() const { return console_enabled_.load(); }
        bool isFileEnabled() const { return file_enabled_.load(); }
        LogLevel getMinLevel() const { return min_level_.load(); }
